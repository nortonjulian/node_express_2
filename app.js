...
describe("POST /auth/login", function () {
  ...
  test("should return 401 when incorrect username and password are provided", async () => {
    const response = await request(app).post("/auth/login").send({ username: "incorrect", password: "incorrect" });
